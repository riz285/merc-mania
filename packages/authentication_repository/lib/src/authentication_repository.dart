...
class ResetPasswordFailure implements Exception {
  const ResetPasswordFailure([this.message = 'Send password reset request to email failure.',]);
  final String message;
}
...
extension on firebase_auth.User {
  ...
  User get toUser {
    return User(id: uid, email: email, firstName: displayName, photo: photoURL);
  }
}